...
<%!public boolean list(HttpServletRequest request, String drv,String url,
	...
	try{
		...
		//总记录数查询SQL
		String sql1 ="select count(*) as countall from schedule where username='"+username+"'";
		...
		rs1.close();
		String sql2 = "select * from schedule where username='"+username+"' order by year desc, month desc,day desc limit "+start+","+pageSize;
...
<%!public boolean insert(HttpServletRequest request, String drv,String url,
	...
	try{
		...
		sql+="values('"+username+"','"+year+"','"+month+"','"+day+"','"+plan+"')";
...
<%!public boolean select(HttpServletRequest request, String drv,String url,
	...
	try{
		...
		if(rs.next()){
			...
			request.setAttribute("year", (String)(rs.getString("year")));
			request.setAttribute("month", (String)(rs.getString("month")));
			request.setAttribute("day", (String)(rs.getString("day")));
			request.setAttribute("plan", (String)(rs.getString("plan")));
...
<%!public boolean update(HttpServletRequest request, String drv,String url,
	...
	try{
		...
		//取得更新SQL
		String sql="update schedule set year='"+year+"', month='"+month+"', day='"+day+"',plan='"+plan+"' where id="+id;
