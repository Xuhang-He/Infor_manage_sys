...
<%
	...
	if(session.getAttribute("username")==null){
		...
		if(method.equals("list")){//列表操作
			...
			topage="../worklog_edit.jsp";// 跳转到修改页
...
<%!public boolean select(HttpServletRequest request, String drv,String url,
	...
	try{
		...
		if(rs.next()){
			...
			request.setAttribute("description", (String)(rs.getString("description")));
			request.setAttribute("logtime", (String)(rs.getString("logtime")));
		}
		rs.close();
		stm.close();
		conn.close();
